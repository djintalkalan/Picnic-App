...
import { EmitterSubscription, Image, ImageBackground, Linking, Platform, SafeAreaView, StyleSheet, TouchableOpacity, View } from 'react-native';
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ margin: scaler(20) }}>
                <Button title='Join now for $18 a year' onPress={() => Linking.openURL('https://apps.apple.com/account/subscriptions')} />
                <Text style={{ fontWeight: '700', fontSize: scaler(14), alignSelf: 'center', marginTop: scaler(15) }}>or try membership at $1.99 a month</Text>
            </View>
        </SafeAreaView>
    );
}
