...
const EventList: FC<any> = (props) => {
    ...
    const _renderItem = useCallback(({ item }, rowMap) => {
        const { ticket_type, ticket_plans = [], is_event_member, city, state, country, is_free_event, event_date, event_currency, event_fees, event_start_date_time, event_end_date_time } = item
