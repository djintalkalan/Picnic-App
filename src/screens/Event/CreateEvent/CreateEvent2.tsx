...
const CreateEvent2: FC<any> = props => {
  ...
  const onPressSubmit = useCallback(() => handleSubmit((data) => {
    ...
    payload.event_start_date_time = stringToDate(payload?.event_date + " " + payload?.event_start_time, "YYYY-MM-DD", "-")
    payload.event_end_date_time = isMultidayEvent ?
      stringToDate(payload?.event_end_date + " " + payload?.event_end_time, "YYYY-MM-DD", "-") :
      stringToDate(payload?.event_date + " " + "23:59", "YYYY-MM-DD", "-")
