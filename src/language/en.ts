export const en = {
    ...
    forgot_password_text: "Please enter your registered email address we will send an otp on this email",
    ...
    must_be_eight: "Must be at least 8 characters and combination of upper case, number and special character",
