export const en = {
  ...
  forgot_password_text:
    'Please enter your email address and we will send you a recovery code.',
  send_instruction: 'Send instructions',
  create_new_password: 'Create new password',
  create_new_password_text:
    'Your new password must be different from previous used passwords',
  must_be_eight:
    'Must be at least 8 characters and combination of upper case, lower case, number and special character',
  ...
  app_needs_location_permission:
    'App needs location permission to verify your current location',
