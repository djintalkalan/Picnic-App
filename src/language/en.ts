export const en = {
  ...
  start_time_invalid: 'Event start time should be greater than current time in selected timezone',
  end_time_invalid: 'Event end time should be greater than start time',
  event_date_invalid: 'Event date should be equal or greater than current date in selected timezone',
  ...
  finalizing_uploads: 'Finalizing upload',
