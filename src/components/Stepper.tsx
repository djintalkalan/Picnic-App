...
export const Stepper: FC<StepperProps> = (props) => {
    const { totalSteps, step, isBackButton = false } = props
    return (
        <View style={styles.container} >
            {isBackButton && <View style={{ position: 'absolute', left: 0, alignItems: 'center' }} >
                ...
                {new Array(totalSteps).fill(1).map((_, i) => {
                    return (
                        <Fragment key={i} >
                            ...
                            {i + 1 == step ? <View style={styles.selectedView} >
