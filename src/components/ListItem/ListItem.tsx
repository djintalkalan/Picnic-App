...
export const TicketView: FC<ITicketView> = ({ size = 'normal', capacity_type, is_event_admin = false, capacity = 0, is_event_member = false, total_sold_tickets = 0, is_booking_disabled = 0 }) => {
