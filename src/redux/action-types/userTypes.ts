...
const UserTypes = {
  ...
  SET_USER_UPCOMING_EVENTS: 'SET_USER_UPCOMING_EVENTS',
  GET_USER_UPCOMING_EVENTS: 'GET_USER_UPCOMING_EVENTS',
  SET_USER_PAST_EVENTS: 'SET_USER_PAST_EVENTS',
  GET_USER_PAST_EVENTS: 'GET_USER_PAST_EVENTS',
